...
def SourceTest(unittest.TestCase):
    '''
    It is used to test Source class.
    '''
    def setUp(self):
        '''
        It will set up an instance of Sources which we will use in each test.
        '''
    ...
    def test_instance(self):
        '''
        To test whether th class is initialized properly.
        '''
